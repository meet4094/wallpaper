    ...
    <div class="main-sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item {{ @$title == 'api_call' ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/api_call') }}"><i class="fe fe-box"></i><span class="sidemenu-label">User</span></a>
            </li>
            <li class="nav-label">App Setting</li>
            <li class="nav-item {{ @$title == 'appsetting' ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/app_setting') }}"><i class="fe fe-box"></i><span class="sidemenu-label">App</span></a>
            </li>
        </ul>
    </div>
</div>