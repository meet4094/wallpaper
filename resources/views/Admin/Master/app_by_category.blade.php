    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.st == 'success') {
                        $('#add_app_by_category_modal').modal('toggle');
                        Swal.fire({
                            icon: 'success',
                            title: 'Success!',
                            text: response.msg,
        ...
        function editable_remove(data_delete) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('delete_app_by_category') }}",
                        type: 'post',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id
        ...
        function edit_app_by_category(edit_category) {
            var id = $(edit_category).data('val');
            $.ajax({
                type: 'POST',
                url: '/getappbycategorydata',
                data: {
                    id: id
                },
                success: function(response) {
                    ...
                    if (response.st == 'success') {
                        ...
                        $('#profile_img_container').append('<img width="200"; src="' +
                            response.msg.image +
                            '" />');
                        $('#add_app_by_category_modal').modal('show');
                    } else {
                        alert('failed');
                    }
                },
