...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <button type="button" class="btn btn-outline-primary rounded" id="toggler" data-toggle="modal" data-target="#add_category_modal">
            Add Category
        </button>
        <div id="add_category_modal" class="modal fade" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url ('add_category') }}" class="ajax-form-submit" id="cform" method="post" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class="float-left" for="category">Name<span class="tx-danger">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="dropify" id="dropify_image" name="image" data-default-file="" data-height="200">
                                                    </div>
                                                    <!-- <div class="form-group">
                                                        <img src="" alt="..." class="img-thumbnail imgsize d-none" id="profile_img_container" style="max-width: 250px; max-height: 145px;">
                                                    </div> -->
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.st == 'success') {
                    ...
                    $('#dropify_image').attr('data-default-file', response.msg.image);
